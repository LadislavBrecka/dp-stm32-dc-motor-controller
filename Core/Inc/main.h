...
#define RESET_POS_BUTTON_Pin GPIO_PIN_10
#define RESET_POS_BUTTON_GPIO_Port GPIOB
#define RESET_POS_BUTTON_EXTI_IRQn EXTI15_10_IRQn
...
#define RESET_CLOSED_LOOP_BUTTON_Pin GPIO_PIN_9
#define RESET_CLOSED_LOOP_BUTTON_GPIO_Port GPIOA
#define RESET_CLOSED_LOOP_BUTTON_EXTI_IRQn EXTI9_5_IRQn
